...
Gem::Specification.new do |s|
  ...
  s.files = ["spec/orm_adapter/adapters/active_record_spec.rb", "spec/orm_adapter/adapters/data_mapper_spec.rb", "spec/orm_adapter/adapters/mongoid_spec.rb", "spec/orm_adapter/base_spec.rb", "spec/orm_adapter/example_app_shared.rb", "spec/orm_adapter_spec.rb", "spec/spec_helper.rb"]
  ...
  s.test_files = ["spec/orm_adapter/adapters/active_record_spec.rb", "spec/orm_adapter/adapters/data_mapper_spec.rb", "spec/orm_adapter/adapters/mongoid_spec.rb", "spec/orm_adapter/base_spec.rb", "spec/orm_adapter/example_app_shared.rb", "spec/orm_adapter_spec.rb", "spec/spec_helper.rb"]
