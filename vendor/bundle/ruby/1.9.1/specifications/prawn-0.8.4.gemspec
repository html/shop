...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<prawn-core>, ["< 0.9", ">= 0.8.4"])
      s.add_runtime_dependency(%q<prawn-layout>, ["< 0.9", ">= 0.8.4"])
      s.add_runtime_dependency(%q<prawn-security>, ["< 0.9", ">= 0.8.4"])
    else
      s.add_dependency(%q<prawn-core>, ["< 0.9", ">= 0.8.4"])
      s.add_dependency(%q<prawn-layout>, ["< 0.9", ">= 0.8.4"])
      s.add_dependency(%q<prawn-security>, ["< 0.9", ">= 0.8.4"])
    end
  else
    s.add_dependency(%q<prawn-core>, ["< 0.9", ">= 0.8.4"])
    s.add_dependency(%q<prawn-layout>, ["< 0.9", ">= 0.8.4"])
